...
export class RealtimeNBodySimulationGPUBarnesHut {
  ...
  // Pre-allocated host-side buffers and views to avoid memory churn
  private forcesUniformsHostBuffer = new ArrayBuffer(16);
  private forcesUniformsU32 = new Uint32Array(this.forcesUniformsHostBuffer);
  private forcesUniformsF32 = new Float32Array(this.forcesUniformsHostBuffer);
