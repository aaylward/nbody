...
export function fromParticleObjects(
  ...
  const data = createParticleArray(numParticles);

  let offset = 0;
  // Optimization: Inlined setParticle logic and manual offset increment
...
export function toParticleObjects(data: Float32Array): Array<{
  ...
  let idx = 0;
  // Optimization: Inlined getParticle logic and direct offset iteration
