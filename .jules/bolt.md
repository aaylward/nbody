...
## 2025-05-19 - [Avoided Dynamic Bind Group Re-creation]
**Learning:** In WebGPU double-buffered loops, recreating `GPUBindGroup` objects dynamically each frame using `device.createBindGroup` adds significant CPU overhead and generates JS garbage.
