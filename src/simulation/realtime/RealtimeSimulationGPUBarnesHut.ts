...
export class RealtimeNBodySimulationGPUBarnesHut {
  ...
  // Reusable buffers to prevent memory churn
  private forcesUniformsBuf: ArrayBuffer = new ArrayBuffer(16);
  private forcesUniformsU32: Uint32Array = new Uint32Array(this.forcesUniformsBuf);
  private forcesUniformsF32: Float32Array = new Float32Array(this.forcesUniformsBuf);
